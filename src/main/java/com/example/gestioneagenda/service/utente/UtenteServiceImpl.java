...
import com.example.gestioneagenda.repository.utente.UtenteRepository;
...
public class UtenteServiceImpl implements UtenteService{
    ...
    @Override
    public Utente caricaSingoloUtenteConAgenda(Long id) {
        return repository.findUtenteConAgenda(id).orElse(null);
    }

package com.example.gestioneagenda.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/utente/userInfo").authenticated() // Tutti i loggati
                        .requestMatchers("/api/utente/**").hasRole("ADMIN")      // Solo Admin


                        .requestMatchers("/api/agenda/**").hasAnyRole("ADMIN", "CLASSIC_USER")
